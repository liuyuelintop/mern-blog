        ...
        <div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                ...
                <div className='relative w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-full' onClick={() => filePickerRef.current.click()}>
                    ...
                    <img src={imageFileUrl || currentUser.profilePicture} alt="user" className={`rounded-full w-full h-full object-cover border-8 border-[lightgray] ${imageFileUploadProgress &&
                ...
                <TextInput type='password' id='password' placeholder='username' onChange={handleChange} />
